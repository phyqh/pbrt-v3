...
#ifndef PBRT_LIGHTSAMPLERS_BORAS_H
#define PBRT_LIGHTSAMPLERS_BORAS_H
...
// from SIGGRAPH 2018
class BayesianOnlineRegressionLightSampler : public LightTreeSampler {
public:
  BayesianOnlineRegressionLightSampler(uint32_t shadingPointClusters, uint32_t directionalGridNumber, 
